var Intern = require('../models/InternApplication');
...
exports.intern_update_get = function(req, res, next) {
    ...
    models.Intern.findById(
        req.params.intern_id
            ...
            // renders a post form
            res.render('forms/intern_form', { title: 'Update Intern', intern: intern, layout: 'layouts/detail'});
...
exports.intern_list = function(req, res, next) {
        ...
        models.Intern.findAll().then(interns =>{
          ...
          res.render('pages/intern_list', { title: 'Intern List', interns:interns, layout: 'layouts/list'});
        }).catch(error =>{
            console.log("There was an error: " + error);
            res.status(404).send(error);
        });
