...
!(function (e, t) {
        ...
        r != C
          ...
          d.getById
            ...
            : ((b.filter.ID = function (e) {
              ...
              return function (e) {
                const t = typeof e.getAttributeNode !== 'undefined'
  ...
  (S.Event = function (e, t) {
    ...
    e && e.type
      ...
      (this.isDefaultPrevented = e.defaultPrevented
        ...
        ? Ce
        : Ee),
      (this.target = e.target && e.target.nodeType === 3
        ? e.target.parentNode
        : e.target),
  ...
  function Oe(e, t) {
    let n; let r; let i; let o; let a; let
      s;
    if (t.nodeType === 1) {
      ...
      return (
        `${parseFloat(Be(e, 'marginLeft'))
            || e.getBoundingClientRect().left
              - We(e, { marginLeft: 0 }, () => e.getBoundingClientRect().left)}px`
      );
    }
  })),
